// pages/admin/finance/DetailedReport.jsx
...
/**
 * Admin - Page 3 of the finance reports suite: the drill-down. A
 * filterable, paginated invoice table (academic year tabs + term /
 * classroom / status / search filters), alongside a per-term summary
 * and a top-10 debtors list so admin can go from "who owes what"
 * straight to a specific invoice.
 */
export default function AdminFinanceDetailedReport() {
